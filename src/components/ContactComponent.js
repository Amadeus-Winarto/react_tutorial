...
const validEmail = val => (!val) || (/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,5}$/i.test(val));
                    ...
                    <div className="col-12 col-md-9">
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={{size: 3, offset: 1}}>
                                <Control.select model=".contact-type" model=".form-control" name="contactType">
                                    <option>Tel.</option>
                                    <option>Email</option>
                                </Control.select>
                            </Col>
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.textarea model=".message" className="form-control" id="message" name="message" placeholder="Your Feedback" rows="12" />
                            </Col>
                        </Row>
                        <Row className="form-group">
